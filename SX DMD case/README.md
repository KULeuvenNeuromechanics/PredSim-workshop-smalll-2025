...
**Additional information:** The protocol of the clinical examination is provided in [Documentation](PredSim-workshop-smalll-2025/Documentation)
	...
	- Edit S.settings.muscle_pass_stiff_shift in the settings file based on the printed average shift (outcome from [Code/Personalize_passive_muscle_stiffness_based_on_CE.m](https://github.com/KULeuvenNeuromechanics/PredSim-workshop-smalll-2025/blob/main/SX%20DMD%20case/Code/Personalize_passive_muscle_stiffness_based_on_CE.m).
