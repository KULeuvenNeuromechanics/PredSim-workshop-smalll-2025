...
We will be using the 2D model called gait1018. Because PredSim is using the 3D model by default, we need to make a small adjustment to the main.m script. On line 18 and line 23 of PredSim/main.m, change 'Falisse_et_al_2022' with 'gait1018'. See the documentation of PredSim for further information (https://github.com/KULeuvenNeuromechanics/PredSim).
